-- TS_MIGRATION: keep the TypeScript-owned Sprout writer's source timestamps
-- ordered atomically so a successful page commit cannot violate the source guard.
BEGIN;
