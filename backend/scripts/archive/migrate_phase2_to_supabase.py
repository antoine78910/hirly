"""Copy Phase 2 Mongo collections to Supabase without switching app routing.

Usage from repo root:
    backend\\venv\\Scripts\\python.exe backend\\scripts\\migrate_phase2_to_supabase.py
...
Users and user_sessions are intentionally not migrated.
"""
...
TABLES = ("profiles", "swipes", "applications", "browser_submission_runs")
