...
export const evidenceBackedApplicationAgent = defineAgent({
  meta: {
    key: "hirly.applicationAgent",
    version: "1.0.0",
    description: "Evidence-backed application assistant.",
  ...
  tools: [
    {
      name: "analyze_job",
      operationRef: { key: "hirlyJob.analyze", version: "1.0.0" },
      automationSafe: true,
    },
    {
      name: "prepare_application",
      operationRef: { key: "hirlyApplication.prepare", version: "1.0.0" },
      automationSafe: true,
    },
    {
      name: "verify_application",
      operationRef: { key: "hirlyApplication.verify", version: "1.0.0" },
      automationSafe: true,
    },
    {
      name: "freeze_application",
      operationRef: { key: "hirlyApplication.freeze", version: "1.0.0" },
      automationSafe: true,
    },
    {
      name: "submit_application",
      operationRef: { key: "hirlyApplication.submit", version: "1.0.0" },
