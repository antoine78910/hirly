      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-14">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 text-center">
            ...
            <p className="font-display font-bold text-lg leading-snug text-zinc-700">
        ...
        {/* Feature table */}
        <div className="mb-14">
          <h2 className="font-display font-bold text-2xl tracking-tight mb-5">
          ...
          <div className="rounded-2xl border border-zinc-200 overflow-hidden">
            <div className="grid grid-cols-3 bg-zinc-50 border-b border-zinc-200 px-5 py-3">
              ...
              <p className="text-xs font-semibold text-linkedin uppercase tracking-widest text-center">
                Hirly
              </p>
              <p className="text-xs font-semibold text-zinc-500 uppercase tracking-widest text-center">
                {page.competitor}
              </p>
            </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2">
                    {row.hirly === "Non" ? (
                      ...
                      <span className="text-xs font-semibold text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-full text-center">
                        {row.hirly}
                      </span>
                    )}
                  </div>
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              to="/compare/hirly-vs-linkedin"
              className="text-sm font-medium text-zinc-600 hover:text-linkedin border border-zinc-200 rounded-full px-3 py-1.5 hover:border-linkedin transition-colors"
            >
              Hirly vs LinkedIn
            </Link>
            <Link
              to="/compare/hirly-vs-indeed"
              className="text-sm font-medium text-zinc-600 hover:text-linkedin border border-zinc-200 rounded-full px-3 py-1.5 hover:border-linkedin transition-colors"
            >
              Hirly vs Indeed
            </Link>
