  ...
  return (
    <AppPage className="sprout bg-sprout-bg text-white md:bg-transparent md:py-8 dark:md:text-zinc-100">
      ...
      <AppPageScroll className={APP_CONTENT_WIDTH}>
        ...
        />
        <p className="mt-1 text-sm text-sprout-muted md:hidden">
          Your AI career coach, updated daily. Tap Refresh to re-run.
        </p>
        ...
        >
          ...
          <div className="mt-3 flex items-end gap-3">
            <p
              ...
              data-testid="recruiter-score"
            >
              {r.score ?? "—"}
            </p>
            <p className={`font-semibold mb-2 ${labelColor}`} data-testid="recruiter-label">
              {r.label || ""}
            </p>
          </div>
          <p
            className="mt-3 text-white/90 text-[15px] leading-relaxed"
            data-testid="recruiter-summary"
          >
            {r.summary}
          </p>
        </section>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span
                        className={`text-[10px] uppercase font-bold tracking-wider px-2 py-1 rounded-full border ${impactStyle}`}
                      >
                        {g.impact} impact
                      </span>
                    </div>
              ...
              {data.certifications.map((c, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-sprout-muted">
                      {c.provider}
