  ...
  return (
    <div className="sprout min-h-dvh bg-sprout-bg text-white pb-28">
      <header className="px-5 pt-6 max-w-md mx-auto">
        <h1 className="font-display font-black text-3xl tracking-tighter">Emails</h1>
        <p className="text-sm text-sprout-muted mt-1">Tailored outreach + recruiter replies, in one inbox.</p>
      </header>
      <div className="max-w-md mx-auto px-5 mt-16 text-center" data-testid="emails-empty">
        ...
        <p className="mt-2 text-sprout-muted text-sm max-w-xs mx-auto">
          Connect your Gmail to send tailored applications directly and track recruiter replies right here.
        </p>
