...
import { GETTING_STARTED_VIDEO_URL } from "./gettingStartedContent";
import { SUBMIT_DRAFTS_VIDEO_URL } from "./submitDraftsContent";
...
const MODULES_EN = [
  { module_id: "mod_getting_started", title: "Getting Started", description: "How the course works, why it matters, and what happens if you skip the rules.", category: "fundamentals", sort_order: 1, duration_seconds: 480, video_url: GETTING_STARTED_VIDEO_URL, completed: false },
...
const MODULES_FR = [
  { module_id: "mod_getting_started", title: "Pour bien commencer", description: "Comment fonctionne le cours, pourquoi c'est important, et les risques si tu ignores les règles.", category: "fundamentals", sort_order: 1, duration_seconds: 480, video_url: GETTING_STARTED_VIDEO_URL, completed: false },
