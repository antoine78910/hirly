...
const MODULES_EN = [
  ...
  },
  {
    ...
    title: "Submit Drafts & Payment",
    description: "How to submit work, get feedback, and how payments work.",
    category: "interview",
    sort_order: 5,
    duration_seconds: 480,
...
const MODULES_FR = [
  {
    ...
    description:
      "Comment fonctionne le cours, pourquoi c'est important, et les risques si tu ignores les règles.",
    category: "fundamentals",
    sort_order: 1,
    duration_seconds: 480,
    video_url: GETTING_STARTED_VIDEO_URL,
  ...
  },
  {
    ...
    description:
      "Comment soumettre ton travail, obtenir des retours et comment fonctionne le paiement.",
    category: "interview",
    sort_order: 5,
    duration_seconds: 480,
    video_url: SUBMIT_DRAFTS_VIDEO_URL,
