...
export const FINANCE_DEMO_JOBS = [
  ...
  financeJob({
    id: "sg_trader_asst",
    title: "Trader Assistant Actions",
  ...
  financeJob({
    id: "cacib_struct",
    title: "Structurer Produits Dérivés",
    company: "Crédit Agricole CIB",
    location: "Paris, France",
    salaryK: 70,
    seniority: "senior",
  ...
  financeJob({
    id: "hsbc_levfin",
    title: "Analyste Leveraged Finance",
    company: "HSBC France",
    location: "Paris, France",
    salaryK: 62,
    matchScore: 90,
  ...
  financeJob({
    id: "bourso_pm",
    title: "Product Manager Banque Digitale",
    company: "Boursorama",
  ...
  financeJob({
    id: "rothschild_ecm",
    title: "Analyste ECM (Equity Capital Markets)",
  ...
  financeJob({
    id: "natixis_aml",
    title: "Analyste Lutte Anti-Blanchiment (AML)",
    company: "Natixis",
    location: "Paris, France",
    salaryK: 46,
    postedDaysAgo: 6,
  ...
  financeJob({
    id: "hsbc_python",
    title: "Développeur Python Finance",
    company: "HSBC France",
    location: "Paris, France",
    salaryK: 58,
    remote: "hybrid",
...
export const FINANCE_DEMO_PROFILE = {
  ...
  cv_text:
    "Analyst with internship experience in investment banking and asset management in Paris.",
