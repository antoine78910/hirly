...
export const blogPosts = [
  {
    ...
    ctaMid: { text: "Laisse Hirly postuler pour toi", href: "/onboarding" },
    ctaEnd: { text: "Commence à swiper tes prochaines offres", href: "/onboarding" },
    sections: [
      {
...

  {
    ...
    ctaMid: { text: "Essayer Hirly gratuitement", href: "/onboarding" },
    ctaEnd: { text: "Commencer avec Hirly", href: "/onboarding" },
    sections: [
      {
...

  {
    ...
    ctaMid: { text: "Tester l'automatisation avec Hirly", href: "/onboarding" },
    ctaEnd: { text: "Automatise tes candidatures avec Hirly", href: "/onboarding" },
    sections: [
      {
...

  {
    ...
    ctaMid: { text: "Laisser Hirly soumettre directement à l'ATS", href: "/onboarding" },
    ctaEnd: { text: "Postuler via Hirly et bypasser les formulaires", href: "/onboarding" },
    sections: [
      {
...

  {
    ...
    ctaMid: { text: "Essayer le matching IA de Hirly", href: "/onboarding" },
    ctaEnd: { text: "Trouvez vos prochaines offres avec Hirly", href: "/onboarding" },
    sections: [
      {
...

  {
    ...
    ctaMid: { text: "Swiper tes premières offres sur Hirly", href: "/onboarding" },
    ctaEnd: { text: "Essayer l'app maintenant", href: "/onboarding" },
    sections: [
      {
