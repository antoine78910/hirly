...
const QUIZZES_EN = {
  quiz_mod_getting_started: {
    ...
    questions: [
      q(
        "gs1",
        "The course is divided into how many main parts?",
        [
...

          {
            id: "b",
            label:
              "5 parts — warm-up, content creation, account management, submission & payment, resources",
          },
      ...
      q(
        "gs2",
        "If you skip or mishandle the warm-up strategy, you risk:",
        [
      ...
      q(
        "gs3",
        "The English example videos from the US competitor are there to:",
        [
      ...
      q(
        "gs4",
        "What language must the content you publish be in?",
        [
      ...
      q(
        "gs5",
        "If you have a problem or question during the course, you should:",
        [
  ...
  quiz_mod_warm_up: {
    ...
    questions: [
      q(
        "wu1",
        "Phase 0 (Lurker Mode) covers which days on a brand-new account?",
        [
      ...
      q(
        "wu2",
        "On Day 1, how many posts should you like according to the SOP?",
        [
      ...
      q(
        "wu3",
        "Day 1 follow limit and Phase 1 daily time budget are:",
        [
      ...
      q(
        "wu4",
        "Controlled posting schedule from Day 5 onward:",
        [
      ...
      q(
        "wu5",
        "A post at 450 views most likely means:",
        [
  ...
  quiz_mod_creating_content: {
    ...
    questions: [
      q(
        "cc1",
        "The hook window called out in the Filming Playbook is:",
        [
      ...
      q(
        "cc2",
        "Recommended total video length and new-account target:",
        [
      ...
      q(
        "cc3",
        "Roughly what share of viewers watch without sound?",
        [
      ...
      q(
        "cc4",
        "In-video caption best practice from the course:",
        [
      ...
      q(
        "cc5",
        "Correct Hirly product demo flow order:",
        [
          { id: "a", label: "Show application history → swipe → mention AI → upload resume" },

          {
            id: "b",
            label: "Upload resume → swipe to apply → mention AI resume/cover letter → show history",
          },
  ...
  quiz_mod_account_management: {
    ...
    questions: [
      q(
        "am1",
        "Baseline daily rhythm after warmup (per account):",
        [
      ...
      q(
        "am2",
        "View-count thresholds from the SOP:",
        [
      ...
      q(
        "am3",
        "US posting windows listed in the course (ET):",
        [
      ...
      q(
        "am4",
        "Phase 1 engagement cap per scroll session:",
        [
      ...
      q(
        "am5",
        "Which behavior defines a 'dead account' after warmup?",
        [
  ...
  quiz_mod_submit_drafts: {
    ...
    questions: [
      q(
        "sd1",
        "Where do you submit your finished video?",
        [
      ...
      q(
        "sd2",
        "Before submitting on Topr, you must:",
        [
      ...
      q(
        "sd3",
        "Right after you submit on Topr, your video status is:",
        [
      ...
      q(
        "sd4",
        "To receive payment, you need to:",
        [
      ...
      q(
        "sd5",
        "First time on Topr — the correct flow includes:",
        [
          {
            id: "a",
            label:
              "Sign up → Creator → join campaign → Create content for this campaign → submit post URL",
          },
  ...
  quiz_mod_content_bank: {
    ...
    questions: [
      q(
        "cb1",
        "How should you use Content Bank scripts?",
        [
          {
            id: "a",
            label: "Adapt to your delivery while keeping the core hook and Hirly mentions",
          },
      ...
      q(
        "cb2",
        "Warm Up post guidelines often specify slowing B-roll to:",
        [
      ...
      q(
        "cb3",
        "When demonstrating Hirly, which feature should lead?",
        [
      ...
      q(
        "cb4",
        "Best method to film product demos per the course:",
        [
      ...
      q(
        "cb5",
        "Brand name in scripts must stay:",
        [
      ...
      q(
        "cb6",
        "Where should you get the official Hirly logo for videos?",
        [
      ...
      q(
        "cb7",
        "In the Good/Better/Best logo format, what is the Best option?",
        [
...
const QUIZZES_FR = {
  quiz_mod_getting_started: {
    ...
    questions: [
      q(
        "gs1",
        "La formation est divisée en combien de parties principales ?",
        [
...

          {
            id: "b",
            label:
              "5 parties — warmup, création de contenu, gestion du compte, soumission & paiement, ressources",
          },
      ...
      q(
        "gs2",
        "Si tu ignores ou rates la stratégie de warmup, tu risques :",
        [
      ...
      q(
        "gs3",
        "Les vidéos d'exemple en anglais du concurrent américain servent à :",
        [
      ...
      q(
        "gs4",
        "Dans quelle langue dois-tu créer le contenu que tu publies ?",
        [
      ...
      q(
        "gs5",
        "Si tu as un problème ou une question pendant la formation, tu dois :",
        [
  ...
  quiz_mod_warm_up: {
    ...
    questions: [
      q(
        "wu1",
        "La Phase 0 (mode lurker) couvre quels jours sur un compte neuf ?",
        [
      ...
      q(
        "wu2",
        "Le jour 1, combien de posts liker selon la SOP ?",
        [
      ...
      q(
        "wu3",
        "Limite de follows jour 1 et budget temps Phase 1 :",
        [
      ...
      q(
        "wu4",
        "Calendrier de publication contrôlée à partir du jour 5 :",
        [
      ...
      q(
        "wu5",
        "Un post à 450 vues signifie le plus probablement :",
        [
  ...
  quiz_mod_creating_content: {
    ...
    questions: [
      q(
        "cc1",
        "La fenêtre d'accroche du guide de tournage est :",
        [
      ...
      q(
        "cc2",
        "Durée totale recommandée et cible nouveaux comptes :",
        [
      ...
      q(
        "cc3",
        "Quelle part des viewers regarde sans le son ?",
        [
      ...
      q(
        "cc4",
        "Bonnes pratiques de sous-titres in-video du cours :",
        [
      ...
      q(
        "cc5",
        "Ordre correct du flow démo Hirly :",
        [
  ...
  quiz_mod_account_management: {
    ...
    questions: [
      q(
        "am1",
        "Rythme quotidien de base après warmup (par compte) :",
        [
      ...
      q(
        "am3",
        "Créneaux de publication France (Paris — CET/CEST) du cours :",
        [
      ...
      q(
        "am4",
        "Plafond de commentaires Phase 1 par session de scroll :",
        [
      ...
      q(
        "am5",
        "Quel comportement définit un « compte mort » après warmup ?",
        [
  ...
  quiz_mod_submit_drafts: {
    ...
    questions: [
      q(
        "sd1",
        "Où soumets-tu ta vidéo terminée ?",
        [
      ...
      q(
        "sd2",
        "Avant de soumettre sur Topr, tu dois :",
        [
      ...
      q(
        "sd3",
        "Juste après la soumission sur Topr, le statut de ta vidéo est :",
        [
      ...
      q(
        "sd4",
        "Pour recevoir ton paiement, tu dois :",
        [
      ...
      q(
        "sd5",
        "Première fois sur Topr — le bon parcours inclut :",
        [
          {
            id: "a",
            label:
              "Sign up → Creator → rejoindre la campagne → Create content for this campaign → soumettre l'URL du post",
          },
  ...
  quiz_mod_content_bank: {
    ...
    questions: [
      q(
        "cb1",
        "Comment utiliser les scripts de la banque de contenu ?",
        [
      ...
      q(
        "cb2",
        "Les guidelines Warm Up demandent souvent de ralentir le B-roll à :",
        [
          { id: "a", label: "0,5–1×" },
      ...
      q(
        "cb3",
        "En démo Hirly, quelle fonctionnalité doit passer en premier ?",
        [
      ...
      q(
        "cb4",
        "Meilleure méthode pour filmer les démos produit :",
        [
          {
            id: "a",
            label: "Tuto POV — filmer le téléphone/laptop depuis un autre appareil en live",
          },
      ...
      q(
        "cb5",
        "Le nom de marque dans les scripts doit rester :",
        [
      ...
      q(
        "cb6",
        "Où récupérer le logo officiel Hirly pour tes vidéos ?",
        [
          {
            id: "a",
            label: "Le dossier Google Drive partagé dans Bien. Mieux. Le top. → Ressources",
          },
      ...
      q(
        "cb7",
        "Dans le format Good/Better/Best logos, quelle est l'option Best ?",
        [
