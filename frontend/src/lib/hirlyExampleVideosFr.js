    ...
    items: [
      ...
      },
      {
        ...
        content: [
          ...
          subheading("Green screen — sans téléphone ni ordinateur"),
          exampleVideo("sec_cb_green_screen", "Green screen"),
          {
            type: "link",
            text: "Tuto green screen (TikTok)",
            href: "https://www.tiktok.com/@thesocialcreativesclub/video/7338507673932942625?lang=fr",
          },
          subheading("Avec ordinateur portable"),
          exampleVideo("sec_cb_laptop_example", "Ordinateur portable"),
          subheading("Ordinateur portable — sans parole"),
          exampleVideo("sec_cb_laptop_without_talking", "Laptop sans parole"),
          subheading("Avec téléphone ou tablette"),
          exampleVideo("sec_cb_tablet_example", "Téléphone ou tablette"),
        ],
      },
    ],
  },
