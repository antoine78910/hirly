...
export const APP_UI = {
  en: {
    ...
    review: {
      ...
      cvSourceOriginal: "My original CV",
      cvSourceUpdateError: "Could not switch the CV source",
      editCoverLetter: "Edit",
      cancelEdit: "Cancel",
      saveCoverLetter: "Save",
      coverLetterSaved: "Cover letter updated",
      coverLetterSaveError: "Could not save the cover letter",
      editCv: "Edit",
      saveCv: "Save",
      cvSaved: "CV updated",
      cvSaveError: "Could not save the CV",
      experience: "Experience",
      education: "Education",
      languages: "Languages",
      role: "Role",
      ...
      school: "School",
      year: "Year",
      highlightsHint: "One bullet point per line",
      languagesHint: "One language per line, e.g. English - Fluent",
    },
    tracker: {
      title: "Applications",
      ...
      available: "Available",
      autoApplyQueueTitle: "Auto-apply waiting list",
      autoApplyQueueSubtitle: "{n} in queue — Hirly submits these through the employer ATS.",
      autoApplyQueueEmpty: "No applications in the auto-apply queue right now.",
      autoApplyQueuePosition: "#{n}",
      autoApplyQueueStatusQueued: "Queued",
      autoApplyQueueStatusRunning: "Submitting now",
      autoApplyQueueStatusAwaitingReview: "Approve documents to send",
      autoApplyQueueStatusSucceeded: "Submitted",
      autoApplyQueueStatusFailed: "Failed",
      autoApplyQueueStatusSkipped: "Skipped",
    ...
    referralPanel: {
      pageTitle: "Referral",
      pageSubtitle: "Give Premium, get Premium — earn free credits.",
      heading: "Invite friends, earn rewards!",
      body: "For every {goal} friends who sign up with your code, you unlock 1 free month and 40 credits for right swipes — every time.",
      linkCopied: "Referral link copied",
      copyError: "Could not copy link",
      shareError: "Could not share your code",
      progressLabel: "{count}/{goal} friends referred",
      remainingToNext: "{count} more to unlock the next reward",
      totalReferred: "{count} friend{plural} referred in total",
      creditsEarned: " — {count} credits earned so far",
      redeemPlaceholder: "Have a friend's code?",
      redeemApply: "Apply",
      redeemApplying: "...",
      redeemSuccess: "Referral code applied!",
  ...
  fr: {
    ...
    swipe: {
      ...
      feedSuggestionFilters: "Ajuster les filtres",
    ...
    review: {
      ...
      cvSourceOriginal: "Mon CV original",
      cvSourceUpdateError: "Impossible de changer le CV utilisé",
      editCoverLetter: "Modifier",
      cancelEdit: "Annuler",
      saveCoverLetter: "Enregistrer",
      coverLetterSaved: "Lettre de motivation mise à jour",
      coverLetterSaveError: "Impossible d'enregistrer la lettre",
      editCv: "Modifier",
      saveCv: "Enregistrer",
      cvSaved: "CV mis à jour",
      cvSaveError: "Impossible d'enregistrer le CV",
      experience: "Expérience",
      education: "Formation",
      languages: "Langues",
      role: "Poste",
      ...
      year: "Année",
      highlightsHint: "Un point par ligne",
      languagesHint: "Une langue par ligne, ex : Anglais - Courant",
    },
    tracker: {
      title: "Candidatures",
      ...
      failed: "Échec",
      expired: "Expirée",
      expiredCreditRefundedCompact: "Expirée · +1 crédit remboursé",
      ...
      autoApplyQueueTitle: "File d'attente auto-apply",
      autoApplyQueueSubtitle: "{n} en file — Hirly les envoie via l'ATS employeur.",
      autoApplyQueueEmpty: "Aucune candidature dans la file auto-apply pour le moment.",
      autoApplyQueuePosition: "#{n}",
      autoApplyQueueStatusQueued: "En file",
      autoApplyQueueStatusRunning: "Envoi en cours",
      autoApplyQueueStatusAwaitingReview: "Validez les documents pour envoyer",
      autoApplyQueueStatusSucceeded: "Envoyé",
      autoApplyQueueStatusFailed: "Échec",
      autoApplyQueueStatusSkipped: "Ignoré",
    ...
    referralPanel: {
      ...
      pageSubtitle: "Offrez Premium, obtenez Premium — gagnez des crédits gratuits.",
      heading: "Invitez des amis, gagnez des récompenses !",
      body: "Pour chaque tranche de {goal} amis qui s'inscrivent avec votre code, vous débloquez 1 mois gratuit et 40 crédits pour les candidatures en un swipe — à chaque fois.",
      linkCopied: "Lien de parrainage copié",
      copyError: "Impossible de copier le lien",
      shareError: "Impossible de partager votre code",
      progressLabel: "{count}/{goal} amis parrainés",
      remainingToNext: "Encore {count} pour débloquer la prochaine récompense",
      totalReferred: "{count} ami{plural} parrainé{plural} au total",
      creditsEarned: " — {count} crédits gagnés jusqu'ici",
      redeemPlaceholder: "Un code d'un ami ?",
      redeemApply: "Appliquer",
      redeemApplying: "...",
      redeemSuccess: "Code de parrainage appliqué !",
      redeemError: "Code de parrainage invalide",
...
export function getApplicationDisplayStatuses(t) {
  return {
    ...
    expired: {
      ...
      tintLight: "bg-red-50 text-red-900 ring-1 ring-red-200/80",
      tintDark: "bg-[#d9534f] text-white ring-1 ring-red-300/80",
      strip: "bg-[#d9534f] text-white",
      dotLight: "bg-red-500",
      dotDark: "bg-white",
    },
  };
