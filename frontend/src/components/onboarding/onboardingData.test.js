...
describe("localized onboarding welcome copy", () => {
  const expected = {
    de: {
      titles: ["Bring deine Karriere voran", "Bewirb dich in Lichtgeschwindigkeit", "Sichere dir deinen nächsten Erfolg"],
      primaryRole: "deine Zielpositionen",
      industryHint: "Top-Unternehmen",
      tagline: "2× mehr Vorstellungsgespräche. 5× weniger Aufwand.",
    },
    es: {
      titles: ["Impulsa tu carrera", "Solicita empleo a toda velocidad", "Consigue tu próximo logro"],
      primaryRole: "tus puestos objetivo",
      industryHint: "las mejores empresas",
      tagline: "2× más entrevistas. 5× menos esfuerzo.",
    },
    it: {
      titles: ["Fai crescere la tua carriera", "Candidati alla velocità della luce", "Conquista il tuo prossimo traguardo"],
  ...
  it.each(Object.entries(expected))("uses explicit %s welcome copy, placeholders, and tagline", (locale, copy) => {
