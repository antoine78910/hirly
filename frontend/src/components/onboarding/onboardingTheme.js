...
export const ob = {
  ...
  title:
    "font-display font-black text-[1.35rem] sm:text-2xl lg:text-[1.75rem] tracking-tight leading-tight text-zinc-900",
  introTitle:
  ...
  introBody: "text-zinc-600 text-base sm:text-lg leading-relaxed text-center max-w-md px-1",
  introStage:
    "grid w-full shrink-0 overflow-hidden [grid-template-areas:'stack'] place-items-center",
  introSlide: "flex w-full max-w-md flex-col items-center gap-5 sm:gap-6 [grid-area:stack] px-1",
  introImageSlot:
  ...
  chip: "inline-flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-full text-xs sm:text-sm font-medium border transition-colors duration-200 ease-out active:scale-[0.97]",
