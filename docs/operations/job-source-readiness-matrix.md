...
| Recruitee | TS fixture connector plus exact-host bounded approved shadow wrapper | `unverified`; no approved live tenant/country policy is committed | Repository shadow-ready only; repeated complete live evidence is absent | No | None | Current inventory-access policy, two digest-bound complete runs, paid-cohort value, application manual-route corpus, canary and rollback | Exact tenant/country shadow switch; whole provider writer transition through `none` |
| Nicoka | TS fixture connector plus exact-host bounded paginated approved shadow wrapper | `unverified`; no approved live tenant/country policy is committed | Repository shadow-ready only; repeated complete live evidence is absent | No | None | Current inventory-access policy, reconciled live pagination, two digest-bound complete runs, paid-cohort value, application manual-route corpus, canary and rollback | Exact tenant/country shadow switch; whole provider writer transition through `none` |
